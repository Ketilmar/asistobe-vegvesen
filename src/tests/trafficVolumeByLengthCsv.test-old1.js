...
describe('getValues', () => {
  ...
  it('should handle objects with edges', () => {
    // data = {
    //   edges: [],
    // };
    // data = data.data.trafficData.volume.byHour.edges = []
    data = getValues(jsonObj.data.trafficData.volume.byHour.edges[0].node.byLengthRange[0].total.volumeNumbers.volume)
    expectedOutput = 6;
